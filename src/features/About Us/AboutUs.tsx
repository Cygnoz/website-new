...
function AboutUs() {
  ...
  <div className="container px-8 md:px-20 lg:px-52 py-12">
    <div className="flex flex-col md:flex-row justify-between items-start gap-6">
      <h1 className="font-thin text-[#BEF3FF] text-xl sm:text-2xl md:text-[40px] leading-tight max-w-full md:max-w-[500px] whitespace-pre-line">
        {"Our Guiding Principles:\nA Commitment to\nExcellence"}
      </h1>
      <p className="text-white text-sm md:text-base max-w-full md:max-w-[400px]">

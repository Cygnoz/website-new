            ...
            <div className="px-4 mt-3 justify-start flex">
              <button className="bg-[#0099F8] font-gilroy text-white font-thin py-2 px-6 rounded-full flex items-center gap-2 shadow-md hover:bg-[#0089f9] hover:shadow-lg ease-in-out">
                ...
                <span className="text-lg justify-center flex">
                  {" "}
                  <img src={rightarrow} className="w-5 h-6 justify-center flex" alt="" />{" "}
                </span>
              </button>
            </div>
          </div>
          ...
          <div className="relative p-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="col-span-2">
                <img src={career1} alt="Career Image 1" className="w-full h-full object-cover rounded-3xl" />
              </div>

              {/* Right side smaller images */}
              <div className="md:col-span-1 space-y-4">
                <div>
                  <img src={career2} alt="Career Image 2" className="w-full object-cover rounded-xl" />
                </div>
                <div>
                  <img src={career3} alt="Career Image 3" className="w-full object-cover rounded-xl" />
                </div>
              </div>
            </div>
          </div>
